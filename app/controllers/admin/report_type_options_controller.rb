class Admin::ReportTypeOptionsController < ApplicationController
  ...
  # GET /admin/report_type_options
  def index
    @report_type_options = ReportTypeOption.all
  end

  # GET /admin/report_type_options/1
  def show
  end

  # GET /admin/report_type_options/new
  def new
    @report_type_option = ReportTypeOption.new
  end

  # GET /admin/report_type_options/1/edit
  def edit
  end

  # POST /admin/report_type_options
  def create
    @report_type_option = ReportTypeOption.new(report_type_option_params)

    if @report_type_option.save
      redirect_to admin_report_type_option_url(@report_type_option), notice: 'Report type option was successfully created.'
    else
      render :new
    end
  end

  # PATCH/PUT /admin/report_type_options/1
  def update
    if @report_type_option.update(report_type_option_params)
      redirect_to admin_report_type_option_url(@report_type_option), notice: 'Report type option was successfully updated.'
    else
      render :edit
    end
  end

  # DELETE /admin/report_type_options/1
  def destroy
    @report_type_option.destroy
    redirect_to admin_report_type_options_url, notice: 'Report type option was successfully destroyed.'
  end
